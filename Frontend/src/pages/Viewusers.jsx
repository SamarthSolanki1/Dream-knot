        ...
        <DialogContent>
          {bookingDetails ? (
            <div>
              ...
              <h5><strong>Employee Assigned:</strong> {bookingDetails.employee?.name || "N/A"}</h5>
              <p><strong>Email:</strong> {bookingDetails.employee?.email || "N/A"}</p>
              <p><strong>Phone:</strong> {bookingDetails.employee?.phone || "N/A"}</p>
            </div>
          ) : (
